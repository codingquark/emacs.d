...
#+BEGIN_SRC emacs-lisp
  (use-package url
    :ensure nil
    :bind (("C-c h b" . cq-home-assistant-show-default-buffer)
           ("C-c h e" . cq-home-assistant-set-default-entity)
           ("C-c h m" . cq-home-assistant-mode)
           ("C-c h r" . cq-home-assistant-refresh)
           ("C-c h s" . cq-home-assistant-read-state))
    :config
    (require 'auth-source)
    (require 'json)
    (require 'subr-x)
