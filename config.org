...
the Remote Files section). Per-project type-checking and venv settings
belong in the project's =pyrightconfig.json= or =[tool.basedpyright]=
in =pyproject.toml= (=venvPath = "."=, =venv = ".venv"=), not in this
global config.
