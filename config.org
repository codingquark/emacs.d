...
Set up package archives explicitly and ensure use-package is available.
...
Configure a minimal minibuffer completion stack with sensible defaults.
...
Make installed package manuals available through Info.
